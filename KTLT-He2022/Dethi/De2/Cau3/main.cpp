...
a. Hàm ReadArray(char fname[], int a[], int &n) để đọc mảng một chiều từ tập tin được xác định bởi tham số fname,
 các phần tử được đưa vào mảng a, số lượng phần tử đưa vào tham số n. (1đ)
b. Hàm đệ quy trả về phần tử lớn nhất của mảng. (1đ, nếu giải không đệ quy: 0.5đ)
c. Hàm tìm và in ra mảng con dài nhất chứa các phần tử giảm dần liên tiếp. (1.5đ)
